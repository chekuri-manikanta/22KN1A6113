...
This project is made possible by the contributions of the open-source community and the powerful libraries it provides, including NumPy, Pandas, Scikit-learn, Matplotlib, Seaborn, and XGBoost. I extend my gratitude to the developers and maintainers of these libraries for their valuable work. In addition, the mentor Chekuri Dange Manikanta
## contact me 
https://www.linkedin.com/in/dange-manikanta-chekuri-33861726a/
